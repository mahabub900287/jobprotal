    ...
    <div class="container p-5 bg-light mb-4">
        <div class="row user-profile">
                    ...
                    <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a class="btn btn-outline-primary" href="{{ route('frontend.job-post.create') }}">Your Post</a>
                                </div>
                            </div>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.user.update',Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="phone" value="{{ Auth::user()->phone_no }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" name="company_website" class="form-control" value="{{ Auth::user()->company_website }}">
                                </div>
                           </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="file" class="form-control" name="image" value="{{ Auth::user()->avatar }}">
                                </div>
                            </div>
                            <div class="row">
